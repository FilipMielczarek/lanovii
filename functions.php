<?php
/**
 * lanovii functions and definitions
 *
...
function lanovii_setup() {
	/*
		...
		* If you're building a theme based on lanovii, use a find and replace
		* to change 'lanovii' to the name of your theme in all the template files.
		*/
...
function lanovii_scripts() {
	...
	wp_enqueue_script( 'lanovii-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
